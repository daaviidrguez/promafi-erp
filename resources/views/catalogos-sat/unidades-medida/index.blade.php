...
@section('page-subtitle', 'Catálogo SAT de unidades de medida')
...
<div class="card">
    <div class="card-header">
        ...
        <a href="{{ route('catalogos-sat.unidades-medida.create') }}" class="btn btn-primary">+ Nuevo</a>
    </div>
                ...
                <tbody>
                    @forelse($items as $item)
                        <tr>
                            ...
                            <td class="td-right">
                                <a href="{{ route('catalogos-sat.unidades-medida.edit', $item) }}" class="btn btn-light btn-sm">Editar</a>
                                <form action="{{ route('catalogos-sat.unidades-medida.destroy', $item) }}" method="POST" style="display:inline;">@csrf @method('DELETE')
