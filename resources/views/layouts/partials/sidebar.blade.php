...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="sidebar-menu-item">
                    <a href="{{ route('devoluciones.index') }}"
                       class="sidebar-menu-link {{ request()->routeIs('devoluciones.*') ? 'active' : '' }}"
                       title="Devoluciones">
                        <span class="sidebar-menu-icon">↩️</span>
                        <span class="sidebar-menu-text">Devoluciones</span>
                    </a>
                </li>
                @endcan
                ...
                <li class="sidebar-menu-item">
                    <a href="{{ route('notas-credito.index') }}"
                       class="sidebar-menu-link {{ request()->routeIs('notas-credito.*') ? 'active' : '' }}"
                       title="Notas de Crédito">
                        <span class="sidebar-menu-icon">📑</span>
                        <span class="sidebar-menu-text">Notas de Crédito</span>
                    </a>
                </li>
                @endcan
            </ul>
        ...
        <div class="sidebar-section">
            ...
            <ul class="sidebar-menu">
                @can('estado_cuenta.ver')
                <li class="sidebar-menu-item">
                    <a href="{{ route('estado-cuenta.index') }}"
                       class="sidebar-menu-link {{ request()->routeIs('estado-cuenta.*') ? 'active' : '' }}"
                       title="Estado de Cuenta">
                        <span class="sidebar-menu-icon">📋</span>
                        <span class="sidebar-menu-text">Estado de Cuenta</span>
                    </a>
                </li>
                @endcan
...
{{-- Tooltip al colapsar: muestra nombre del módulo al pasar el mouse sobre el icono --}}
