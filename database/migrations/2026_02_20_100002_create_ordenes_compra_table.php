...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('ordenes_compra', function (Blueprint $table) {
            ...
            $table->enum('estado', ['borrador', 'aceptada', 'recibida'])->default('borrador');
            $table->foreignId('cotizacion_compra_id')->nullable()->constrained('cotizaciones_compra')->nullOnDelete();
