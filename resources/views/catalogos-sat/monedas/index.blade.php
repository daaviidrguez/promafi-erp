...
@section('page-subtitle', 'Catálogo de monedas')
...
<div class="card">
    <div class="card-header">
        ...
        <a href="{{ route('catalogos-sat.monedas.create') }}" class="btn btn-primary">+ Nuevo</a>
    </div>
                ...
                <tbody>
                    @forelse($items as $item)
                        <tr>
                            ...
                            <td class="td-right">
                                <a href="{{ route('catalogos-sat.monedas.edit', $item) }}" class="btn btn-light btn-sm">Editar</a>
                                <form action="{{ route('catalogos-sat.monedas.destroy', $item) }}" method="POST" style="display:inline;">@csrf @method('DELETE')
