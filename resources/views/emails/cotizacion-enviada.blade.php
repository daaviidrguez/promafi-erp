                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background: #FFFFFF; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                        <td style="padding: 40px 30px; color: #2F2F2F;">
                            ...
                            <table width="100%" cellpadding="12" cellspacing="0" style="background: #F3F4F6; border-radius: 8px; margin: 0 0 25px 0;">
                                ...
                                <tr>
                                    <td style="font-weight: 600; color: #4B5563; font-size: 14px; border-top: 1px solid #D1D5DB; padding-top: 12px;">Fecha:</td>
                                ...
                                <tr>
                                    <td style="font-weight: 600; color: #4B5563; font-size: 14px; border-top: 1px solid #D1D5DB; padding-top: 12px;">Vigencia:</td>
                                    <td style="color: #2F2F2F; font-size: 14px; text-align: right; border-top: 1px solid #D1D5DB; padding-top: 12px;">
                                        {{ $cotizacion->fecha_vencimiento?->format('d/m/Y') ?? 'N/A' }}
                                    </td>
                                </tr>
                                <tr>
                                    <td style="font-weight: 600; color: #4B5563; font-size: 14px; border-top: 1px solid #D1D5DB; padding-top: 12px;">Condición:</td>
                                    <td style="text-align: right; border-top: 1px solid #D1D5DB; padding-top: 12px;">
                                        @if(($cotizacion->tipo_venta ?? '') === 'credito')
                                            <span style="color: #F59E0B; font-weight: bold; font-size: 14px;">
                                                📅 CRÉDITO {{ $cotizacion->dias_credito_aplicados ?? 0 }} DÍAS
                                            </span>
                                        @else
                                ...
                                <tr>
                                    <td style="font-weight: 600; color: #4B5563; font-size: 16px; border-top: 2px solid #0B3C5D; padding-top: 12px;">Total:</td>
                                    <td style="color: #1F5F8B; font-size: 20px; text-align: right; font-weight: bold; border-top: 2px solid #0B3C5D; padding-top: 12px; font-family: 'Courier New', monospace;">
                                        ${{ number_format($cotizacion->total, 2) }} {{ $cotizacion->moneda ?? 'MXN' }}
                                    </td>
                                </tr>
                            </table>
                            ...
                            <div style="margin-top: 30px; padding-top: 20px; border-top: 2px solid #E5E7EB;">
                                <p style="font-size: 15px; margin: 0 0 5px 0;">Saludos cordiales,</p>
                    ...
                    <tr>
                        <td style="background: #F3F4F6; padding: 30px; text-align: center; font-size: 13px; color: #6B7280; border-top: 1px solid #E5E7EB;">
                            <p style="margin: 0 0 8px 0; font-weight: 600; color: #374151;">{{ $empresa->razon_social }}</p>
                            <p style="margin: 0 0 8px 0;">RFC: {{ $empresa->rfc }}</p>
                            <p style="margin: 0 0 8px 0;">📧 {{ $empresa->email ?? '' }} · 📱 {{ $empresa->telefono ?? '' }}</p>
                            @if($empresa->calle ?? null)
